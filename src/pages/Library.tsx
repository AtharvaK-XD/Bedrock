        ...
        <div className="w-full md:w-auto flex items-center gap-4">
          <div className="relative flex-1 md:w-80">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-[#1a1a1a]/30 backdrop-blur-sm border border-white/10 rounded-xl text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 shadow-sm"
            />
          </div>
          <Button variant="secondary" className="h-[50px] px-4 bg-[#1a1a1a]/30 text-white border-white/10 hover:bg-white/10 backdrop-blur-sm">
      ...
      <div className="flex overflow-x-auto pb-4 mb-8 gap-2 custom-scrollbar">
        ...
        {filteredPrompts.map((prompt) => (
          <motion.div
            ...
            className="bg-[#1a1a1a]/30 backdrop-blur-xl border border-white/5 rounded-3xl p-8 hover:bg-[#1a1a1a]/40 hover:border-white/10 transition-all group flex flex-col cursor-pointer shadow-lg hover:shadow-xl hover:shadow-teal-500/5 relative overflow-hidden"
          >
